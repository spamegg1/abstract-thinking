...
- Combined, rich, complex structures:
  ...
  - geometric,
  - ergodic / stochastic
  - Connection to [systems thinking](../complex/system.md)
...
- This works with wishful thinking (see [problem solving](../solve/README.md)).
- Similarities to [axiomatic thinking](../logic/axiom.md)
