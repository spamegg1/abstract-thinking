...
- We have patterns / models in our brains through the
  [physical world](../physical/README.md) and our senses,
...
- Modus ponens: the heart of reasoning
  - Connections to [rule-based](../ways/rulebased.md) and [axiomatic thinking](axiom.md)
- Deductive,
- Inductive,
- Abductive, and
- Fuzzy reasoning
...
- Similarities to [reductionist / atomic thinking](../ways/atomic.md)

[Back to the Elements](../README.md#the-list-of-elements)
